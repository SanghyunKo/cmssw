...
double logPdfMax = 3.0; double logPdfMin = -3.0; double logPdfNbin = 150.0; double logPdfBinsize = (logPdfMax - logPdfMin)/logPdfNbin;
double logQScaleMax = 4.0; double logQScaleMin = -1.0; double logQScaleNbin = 500.0; double logQScaleBinsize = (logQScaleMax - logQScaleMin)/logQScaleNbin;
...
void BasicHepMCValidation::bookHistograms(DQMStore::IBooker &i, edm::Run const &, edm::EventSetup const &){
  ...
  pdf_u = dqm.book1dHisto("pdf_u", "Log10(PDF(u,x,Q))", (int)logPdfNbin, logPdfMin, logPdfMax,"log_{10}(x*f(x))","Number of Events"); //Log
  pdf_ubar = dqm.book1dHisto("pdf_ubar", "Log10(PDF(ubar,x,Q))", (int)logPdfNbin, logPdfMin, logPdfMax,"log_{10}(x*f(x))","Number of Events"); //Log
  pdf_d = dqm.book1dHisto("pdf_d", "Log10(PDF(d,x,Q))", (int)logPdfNbin, logPdfMin, logPdfMax,"log_{10}(x*f(x))","Number of Events"); //Log
  pdf_dbar = dqm.book1dHisto("pdf_dbar", "Log10(PDF(dbar,x,Q))", (int)logPdfNbin, logPdfMin, logPdfMax,"log_{10}(x*f(x))","Number of Events"); //Log
  pdf_ssbar = dqm.book1dHisto("pdf_ssbar", "Log10(PDF(ssbar,x,Q))", (int)logPdfNbin, logPdfMin, logPdfMax,"log_{10}(x*f(x))","Number of Events"); //Log
  pdf_ccbar = dqm.book1dHisto("pdf_ccbar", "Log10(PDF(ccbar,x,Q))", (int)logPdfNbin, logPdfMin, logPdfMax,"log_{10}(x*f(x))","Number of Events"); //Log
  pdf_bbbar = dqm.book1dHisto("pdf_bbbar", "Log10(PDF(bbbar,x,Q))", (int)logPdfNbin, logPdfMin, logPdfMax,"log_{10}(x*f(x))","Number of Events"); //Log
  pdf_g = dqm.book1dHisto("pdf_g", "Log10(PDF(g,x,Q))", (int)logPdfNbin, logPdfMin, logPdfMax,"log_{10}(x*f(x))","Number of Events"); //Log
  scalePDF = dqm.book1dHisto("scalePDF", "Log10(Q-scale(GeV))", (int)logQScaleNbin, logQScaleMin, logQScaleMax,"log_{10}(Q-scale(GeV))","Number of Events");
