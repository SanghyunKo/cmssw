...
public:
  ...
  // bool passN1HEEPEMHad1Iso;
  // bool passN1HEEPEt;
  // bool passN1HEEPdEtaInSeed;
  // bool passN1HEEPdPhiIn;
  // bool passN1HEEPE2x5OverE5x5;
  // bool passN1HEEPHoverE;
  // bool passN1HEEPdxy;
  // bool passN1HEEPMissingHits;
  // bool passN1HEEPEcalDriven;
  // double HEEPTrkIso;
  // double HEEPEMHad1Iso;
  int HEEPnrSatCrysValue;
  double HEEPTrkIsoValue;
  int HEEPnrMatchedTrk;
...
public:
  ...
  std::vector<NtupleGeneralTrack> tracks;
